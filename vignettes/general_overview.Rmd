...
```{r ji1_plot, fig.width=8, fig.height=8, eval=FALSE, warning=FALSE}
plot(ji1, cutOff = 0.1)
```
...
```{r ji2_plot, fig.width=8, fig.height=8, eval=FALSE, warning=FALSE}
plot(ji2)
```
...
```{r ji3_plot, fig.width=8, fig.height=8, eval=FALSE, warning=FALSE}
plot(ji3)
```
