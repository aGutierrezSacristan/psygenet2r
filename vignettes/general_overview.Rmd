...
```{r heatmap_disease_m,  fig.height=8, fig.width=8, eval=FALSE}
...
```{r plot_psychiatric_heamap, warning = FALSE,  fig.height=8, fig.width=8, eval=FALSE}
...
```{r heatmap_disease_tm, warning = FALSE,  fig.wide = TRUE, eval=FALSE}
