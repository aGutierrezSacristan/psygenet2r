...
```{r plot_disease, fig.width=13, fig.height=11}
...
```{r plot_psychiatric, fig.width=13, fig.height=11}
...
```{r plot_psychiatric1a, fig.width=13, fig.height=11}
plot( m1 )
```
...
```{r plot_psychiatric1b, warning=FALSE, fig.width=13, fig.height=11}
...
```{r heatmap_disease_m, fig.width=13, fig.height=11}
...
```{r plot_psychiatric_heamap, warning = FALSE, fig.width=13, fig.height=11}
...
```{r panther_gene, fig.width=13, fig.height=11}
...
```{r plot_diseaseBarplot, fig.width=13, fig.height=11}
...
```{r plot_diseaseBarplotGene, fig.width=13, fig.height=11}
...
```{r plot_pieChart, fig.width=13, fig.height=11}
...
```{r barplotIP, fig.width=13, fig.height=11}
...
```{r plot_visualizing_single_disease_search, fig.width=13, fig.height=11}
plot ( d1 )
```
...
```{r plot_disease_tm, fig.width=13, fig.height=11}
plot( tm )
```
...
```{r heatmap_disease_tm, warning = FALSE, fig.width=13, fig.height=11}
...
```{r barplot_visualizing_single_disease_search, fig.width=13, fig.height=11}
...
```{r barplot_visualizing_single_gene_search, fig.width=13, fig.height=11}
...
```{r ji1_plot, fig.width=13, fig.height=11}
plot(ji1, cutOff = 0.1)
```
...
```{r ji2_plot, fig.width=13, fig.height=11}
plot(ji2)
```
...
```{r ji3_plot, fig.width=13, fig.height=11}
plot(ji3)
```
