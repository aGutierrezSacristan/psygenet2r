...
<<plot_diseaseBarplot, fig=TRUE, height=8, width=8>>=
<<<<<<< HEAD
=======
...
<<plot_pieChart, fig=TRUE, height=8, width=8>>=
...
<<plot_geneBarplot, fig=TRUE, height=8, width=8>>=
...
<<barplotIP, fig=TRUE, height=8, width=8>>=
