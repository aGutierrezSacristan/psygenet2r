...
```{r pubmed2, fig.cap="Publications that report each gene association with bipolar disorder", fig.wide = TRUE, eval=FALSE}
...
```{r jacc, fig.cap="Bar-plot where the Jaccard Index of each comparison between the list of genes of interest and PsyGeNET's diseases is shown.", fig.wide = TRUE, warning = FALSE, eval= FALSE}
plot( xx )
```
